        ...
        <form role="form" method="POST" action="<?php echo e(route('login')); ?>">
                    ...
                    <div class="col-sm-7 pr30">
                        <div class="section">
                            ...
                            <label for="email" class="field prepend-icon">
                                <input type="email" name="email" id="email" class="gui-input" placeholder="Enter email" value="<?php echo e(old('email')); ?>" autocomplete="off">
            ...
            <div class="panel-footer clearfix p10 ph15">
                ...
                <label class="switch block switch-primary pull-left input-align mt10">
                    <input type="checkbox" name="remember" id="remember" name="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>>
